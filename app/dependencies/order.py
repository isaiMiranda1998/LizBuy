...
def get_order_service(order_repository: Annotated[OrderRepository, Depends(get_order_repository)], cart_repository: Annotated[CartRepository, Depends(get_cart_service)], product_service: Annotated[ProductService, Depends(get_product_service)]):
